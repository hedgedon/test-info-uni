...
import { usePoolDatas, usePoolChartData, usePoolTransactions, usePoolTransactionsGfx } from 'state/pools/hooks'
...
import TransactionTableGfx from 'components/TransactionsTable/gfxTable'

import { useSavedPools } from 'state/user/hooks'
import DensityChart from 'components/DensityChart'
import { MonoSpace } from 'components/shared'
import { useActiveNetworkVersion, useGfxClient } from 'state/application/hooks'
...
export default function PoolPage({
  ...
  console.log('SUBGRAPH DATA::', transactions) // undefined

  const transactionsGfx = usePoolTransactionsGfx(address)
  console.log('GFX DATA::', transactionsGfx) // undefined
      ...
      {poolData ? (
        <AutoColumn gap="32px">
          ...
          <DarkGreyCard>
            ...
            {transactionsGfx ? <TransactionTableGfx transactions={transactionsGfx} /> : <LocalLoader fill={false} />}
          </DarkGreyCard>
        </AutoColumn>
      ) : (
        <Loader />
